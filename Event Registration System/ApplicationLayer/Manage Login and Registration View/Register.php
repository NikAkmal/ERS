		...
		<form action="" method="POST" enctype="multipart/form-data">
			...
			<table id="table">
				...
				<tr><th>
					...
					<input type="text" id="name" name="name"	/></th></tr>
				</p>
				<p>
				<tr><th>
					<label>USERNAME:</label></th><th>
					<input type="text" id="username" name="username"	/></th></tr>
				</p>
				<p>
				<tr><th>	
					<label>PASSWORD:</label></th><th>
					<input type="password" id="password" name="password"	/></th></tr>
				</p>
				<p>
				<tr><th>
					<label>PHONE NUMBER</label></th><th>
					<input type="text" id="phone_number" name="phone_number"	/></th></tr>
				</p>
				<p>
				<tr><th>
					<label>MATRIC ID:</label></th><th>
					<input type="text" id="matric_id" name="matric_id"	/></th></tr>
				</p>
				<p>
				<tr><th>
					<label>ADDRESS:</label></th><th>
					<input type="text" id="address" name="address"	/></th></tr>
				</p>
				<p>
				<tr><th>
